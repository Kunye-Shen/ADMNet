...
image_train_dir = "/DUTS/Image_train/"
label_train_dir = "/DUTS/GT_train/"
...
optimizer = optim.Adam(net.parameters(), lr=1.5e-3, betas=(0.9, 0.999), eps=1e-08, weight_decay=0)
...
for epoch in range(0, epoch_num):
    ...
    for i, data in enumerate(salobj_dataloader):
        ...
        (epoch + 1, epoch_num, (i + 1) * batch_size_train, train_num, ite_num, loss.item() / ite_num))

        del d1, d2, d3, d4, d5, loss

    torch.save(net.state_dict(), model_dir + "MYNet_epoch_%d.pth" % (epoch))
